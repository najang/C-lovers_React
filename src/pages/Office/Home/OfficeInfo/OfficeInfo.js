      ...
      <table className={officeInfo.office__info__table}>
        <tbody>
          <tr className={officeInfo.office__info__table__tr}>
            <td>
              <p className={officeInfo.office__info__table__p__index}>이름</p>
            </td>
            <td>
              <p className={officeInfo.office__info__table__p__index2}>
                클로버산업
              </p>
            </td>
            <td>
              <Link to="./organization">
                <button
                  className={officeInfo.office__organization__button}
          ...
          <tr className={officeInfo.office__info__table__tr}>
            <td>
              <p className={officeInfo.office__info__table__p__index}>주소</p>
            </td>
            <td>
              <p className={officeInfo.office__info__table__p__index2}>
                clover.com
          ...
          <tr className={officeInfo.office__info__table__tr}>
            <td>
              <p className={officeInfo.office__info__table__p__index}>
                총 인원
              </p>
            </td>
            <td>
              <p
                className={officeInfo.office__info__table__p__index2}
              >{`${numOfWorker} 명`}</p>
            </td>
            <td></td>
          </tr>
